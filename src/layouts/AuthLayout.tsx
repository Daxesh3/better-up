...
const AuthLayout: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-900 to-indigo-950 text-white flex-col justify-center items-center p-8">
        <div className="max-w-md text-center">
          ...
          <p className="text-xl text-indigo-200 mb-8">
            Elevate your coaching practice with our Human + AI augmentation platform
          </p>
